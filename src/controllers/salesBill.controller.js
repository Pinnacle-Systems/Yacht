...
import { get as _get, getOne as _getOne, create as _create, update as _update, remove as _remove,getsalesBillItems as _getsalesBillItems } from '../services/salesBill.service.js';
...
async function getsalesBillItems(req, res, next) {
    try {
        res.json(await _getsalesBillItems(req));
    } catch (err) {
        console.error(`Error`, err.message);
    }
}
