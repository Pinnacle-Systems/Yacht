...
import {
  ...
  update as _update,
  remove as _remove,
  getpurchaseBillItems as _getpurchaseBillItems,
  getBarcodeDetail as _getBarcodeDetail,
} from "../services/purchaseBill.service.js";
...
async function getBarcodeDetail(req, res, next) {
  try {
    res.json(await _getBarcodeDetail(req));
  } catch (err) {
    console.error(`Error`, err.message);
  }
}

export { get, getOne, create, update, remove, getpurchaseBillItems,getBarcodeDetail };
