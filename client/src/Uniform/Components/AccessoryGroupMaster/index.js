...
export default function Form() {
  ...
  const {
    ...
    isLoading,
    isFetching,
  } = useGetAccessoryGroupMasterQuery({ params, searchParams: searchValue });
  const {
    data: singleData,
  ...
  const saveData = () => {
    ...
    if (foundItem) {
      Swal.fire({
        text: "The Assessory Group already exists.",
        icon: "warning",
        timer: 1500,
        showConfirmButton: false,
      });
  ...
  const columns = [
    ...
    },
    {
      ...
      className: "font-medium text-gray-900  w-72  py-1  px-2",
      search: "Size Name",
    },
    {
      header: "Status",
