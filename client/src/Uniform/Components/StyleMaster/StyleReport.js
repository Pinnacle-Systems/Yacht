...
const StyleReport = ({
  ...
  const [searchFabricName, setSearchFabricName] = useState("");
                ...
                <tr className="">
                  ...
                  <th className="  px-1 font-medium text-[13px]  text-gray-900  text-center w-32">
                    <input
                      ...
                      onChange={(e) => {
                        setSearchStyleName(e.target.value);
                        setCurrentPage(1);
                      }}
                    />
                  </th>
                  <th className="w-96  px-1 font-medium text-[13px]  text-gray-900  text-center ">
                    <input
                      ...
                      className="text-black h-5   w-full   px-1 focus:outline-none border  border-gray-400 rounded-md"
                      placeholder="Search"
                      value={searchFabricName}
                      onChange={(e) => {
                        setSearchFabricName(e.target.value);
                        setCurrentPage(1);
                      }}
                    />
                  </th>
                ...
                <tbody className="border-2">
                  {currentItems?.map((dataObj, index) => (
                    ...
                    >
                      ...
                      <td className="py-1.5 text-center">{dataObj?.sku} </td>

                      <td className="py-1.5 text-center">
                        {dataObj?.StyleItem?.name}{" "}
                      </td>
