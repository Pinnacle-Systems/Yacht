...
const ActiveTabList = () => {
  ...
  const tabs = {
    ...
    "MATERIAL STOCK REPORT": <MaterialStockReport />,
    ...
    "OPENING  STOCK": <OpeningStockSR />,
    "SALES BILL REPORT": <SalesBillReport />,
    "REFERENCE MASTER": <ReferenceMaster />
  };
