        ...
        <div className="min-h-screen  flex">
          <div className="w-full bg-gradient-to-br from-indigo-900 to-blue-800 p-5 flex flex-col overflow-y-auto">
            <div className="mb-5">
              <img
                className="w-52"
                src="https://www.pinnaclesystems.co.in/assets/imgs/pages/home5/logo.PNG"
              />
            </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-blue-100 text-[12px] tracking-wider  leading-snug">
                      An ERP (Enterprise Resource Planning) system tailored for
                      textile industries streamlines and optimizes various
                      operations, from supply chain management to production
              ...
              <div className="group relative bg-white/10 backdrop-blur-sm p-4 rounded-xl transition-transform hover:scale-[1.03]">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-blue-100 text-[12px] tracking-wider  leading-snug">
                      Certainly, cloud and IoT (Internet of Things) solutions
                      are increasingly important for various industries,
                      including textiles. These technologies can offer enhanced
                      efficiency, real-time monitoring, data analytics, and
                      scalability.
                    </p>
                  </div>
                </div>
              ...
              <div className="group relative bg-white/10 backdrop-blur-sm p-4 rounded-xl transition-transform hover:scale-[1.03]">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-blue-100 text-[12px] tracking-wider  leading-snug">
                      Streamline hospital operations with an integrated ERP
                      solution. Manage patient records, billing, and resource
                      allocation efficiently. Enhance patient care through
                      seamless coordination and data-driven insights.
                    </p>
                  </div>
                </div>
              </div>
